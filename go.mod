...
require (
	github.com/anacrolix/torrent v1.58.1 // BitTorrent client library for torrent handling
	golang.org/x/crypto v0.29.0 // Cryptographic functions for secure credential storage
	golang.org/x/net v0.29.0 // Proxy support for SOCKS5
)
